...
STORAGE_LIMIT_BYTES = STORAGE_LIMIT_GB * 1024 * 1024 * 1024  # 10GB em bytes
STORAGE_WARNING_BYTES = STORAGE_LIMIT_BYTES * STORAGE_WARNING_THRESHOLD  # 8GB em bytes
...
def upload_foto_r2(file, filename: str) -> str | None:
    ...
    try:
        ...
        # Compactar com qualidade otimizada
...
def verificar_espaco_bucket():
    ...
    try:
        ...
        # Se ultrapassou 80%, limpar os 20% mais antigos
        if total_size > STORAGE_WARNING_BYTES:
            ...
            # Calcular quanto precisa liberar (20% do total)
